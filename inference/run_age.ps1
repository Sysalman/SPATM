# =========================================================
# run_age.ps1
# SPATM Age Bias Evaluation
# =========================================================

$BIAS       = "age"
$TOKEN_NAME = "<age-diverse>"
$CHECKPOINT = "C:\Vs_code\Mtech_UAITTI\AITTI\training\checkpoints\age-spatm-v1"

Write-Host ""
Write-Host "========================================="
Write-Host "SPATM Age Bias Evaluation"
...
Write-Host ""
Write-Host "========================================="
Write-Host "Age evaluation complete."
