...
# =========================================================
# run_race.sh
# SPATM Race Bias Evaluation (JarvisLabs)
#
...
# Usage:
#   chmod +x run_race.sh
#   ./run_race.sh                              # uses CHECKPOINT below
#   ./run_race.sh /path/to/checkpoint          # override checkpoint
#
# Env overrides:
...
BIAS="race"
TOKEN_NAME="<race-diverse>"

CHECKPOINT="${1:-${CHECKPOINT:-/home/jl_fs/checkpoints/race-spatm-v1}}"
...
echo ""
echo "========================================="
echo "SPATM Race Bias Evaluation"
...
echo ""
echo "========================================="
echo "Race evaluation complete."
echo "Summaries: $RESULTS_ROOT/spatm_race_summary.txt"
echo "           $RESULTS_ROOT/baseline_race_summary.txt"
echo "========================================="
