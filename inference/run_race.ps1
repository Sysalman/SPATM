# =========================================================
# run_race.ps1
# SPATM Race Bias Evaluation
# =========================================================

$BIAS       = "race"
$TOKEN_NAME = "<race-diverse>"
$CHECKPOINT = "C:\Vs_code\Mtech_UAITTI\AITTI\training\checkpoints\race-spatm-v1"

Write-Host ""
Write-Host "========================================="
Write-Host "SPATM Race Bias Evaluation"
...
Write-Host ""
Write-Host "========================================="
Write-Host "Race evaluation complete."
